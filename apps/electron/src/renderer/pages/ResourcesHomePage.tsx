  ...
  const renderSourceCard = React.useCallback((source: LoadedSource) => {
    ...
    return (
      <div
        ...
        className={cn(
          'group relative flex min-h-[112px] min-w-0 cursor-pointer flex-col rounded-[14px] border border-foreground/8 bg-background/55 p-4 text-left shadow-minimal transition-colors hover:bg-foreground/[0.025] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring/40',
