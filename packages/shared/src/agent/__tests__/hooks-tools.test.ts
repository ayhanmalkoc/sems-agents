...
const policy: HooksPolicy = { secretGuard: 'standard', workspaceBoundary: 'ask', prerequisiteGuard: 'enforce', toolAudit: 'on', customHooks: 'trusted-only', customMaxDurationMs: 2000, customMaxOutputBytes: 4096 }
