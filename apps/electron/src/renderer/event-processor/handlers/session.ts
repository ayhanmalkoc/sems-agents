  ...
  return {
    state: {
      session: {
        ...
        model: event.model === null ? undefined : (event.model ?? session.model),
        llmConnection: event.llmConnection === null ? undefined : (event.llmConnection ?? session.llmConnection),
        enabledSourceSlugs: event.enabledSourceSlugs ?? session.enabledSourceSlugs,
        systemPromptPreset: event.systemPromptPreset ?? session.systemPromptPreset,
        skillSlugs: event.skillSlugs ?? session.skillSlugs,
        delegationMode: event.delegationMode ?? session.delegationMode,
        delegationAllowedAgentIds: event.delegationAllowedAgentIds ?? session.delegationAllowedAgentIds,
      },
      streaming,
    },
    effects: [],
