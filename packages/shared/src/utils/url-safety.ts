...
const DANGEROUS_SCHEMES: ReadonlyMap<string, string> = new Map([
  ...
  [
    'file:',
    'file: URLs are blocked because shell.openExternal can launch local executables on Windows (Electron RCE class). Use an in-app preview block (html-preview, pdf-preview, image-preview, audio-preview, markdown-preview) or open the file from your OS file manager.',
  ],
])
