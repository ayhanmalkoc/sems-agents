...
export const CHANNEL_MAP = {
  ...
  listOpenTargets: invoke(RPC_CHANNELS.openTargets.LIST),
  launchOpenTarget: invoke(RPC_CHANNELS.openTargets.LAUNCH),
  ...
  listFileEntries: invoke(RPC_CHANNELS.fs.LIST_ENTRIES),
  ...
  testSource: invoke(RPC_CHANNELS.sources.TEST),
