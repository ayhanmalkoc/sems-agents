...
const EXPECTED_CHANNELS: string[] = [
  ...
  'browser-pane:click',
  'browser-pane:complete-dock-open',
  'browser-pane:create',
  ...
  'browser-pane:open-dock-request',
  'browser-pane:reload',
  'browser-pane:removed',
  'browser-pane:screenshot',
  'browser-pane:scroll',
  'browser-pane:select',
  'browser-pane:set-dock-bounds',
  'browser-pane:set-dock-bounds-fast',
  ...
  'memory:approve',
  'memory:changed',
  'memory:clearSessionNotes',
  'memory:delete',
  'memory:get',
  'memory:getActivity',
  'memory:getSessionNotes',
