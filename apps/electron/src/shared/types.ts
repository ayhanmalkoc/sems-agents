...
export interface ElectronAPI {
  ...
  getMemorySessionNotes(workspaceId: string): Promise<unknown[]>
  ...
  clearMemorySessionNotes(workspaceId: string, scope: 'session' | 'day'): Promise<number>
