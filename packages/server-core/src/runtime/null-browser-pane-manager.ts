...
export class NullBrowserPaneManager implements IBrowserPaneManager {
  ...
  getOrCreateForSession(_sessionId: string, _options?: { workspaceId?: string | null; mode?: 'window' | 'dock' }): string { return unavailable('getOrCreateForSession') }
  async getOrCreateForSessionAsync(_sessionId: string, _options?: { workspaceId?: string | null; mode?: 'window' | 'dock' }): Promise<string> { return unavailable('getOrCreateForSession') }
  setAgentControl(
    _sessionId: string,
  ...
  // -- Instance management --
  createForSession(_sessionId: string, _options?: { show?: boolean; workspaceId?: string | null; mode?: 'window' | 'dock' }): string { return unavailable('createForSession') }
  async createForSessionAsync(_sessionId: string, _options?: { show?: boolean; workspaceId?: string | null; mode?: 'window' | 'dock' }): Promise<string> { return unavailable('createForSession') }
  ...
  focusBoundForSession(_sessionId: string, _options?: { workspaceId?: string | null; mode?: 'window' | 'dock' }): string { return unavailable('focusBoundForSession') }
  async focusBoundForSessionAsync(_sessionId: string, _options?: { workspaceId?: string | null; mode?: 'window' | 'dock' }): Promise<string> { return unavailable('focusBoundForSession') }
  bindSession(_id: string, _sessionId: string, _options?: { workspaceId?: string | null; mode?: 'window' | 'dock' }): void { unavailable('bindSession') }
